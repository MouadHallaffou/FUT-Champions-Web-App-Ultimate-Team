                    ...
                    <div class="gardient-card">
                        ...
                        <div class="information-player">
                            ...
                            <div class="les-logos-player">
                                <div class="nationalite-log"><img src="${player.flag}" alt="drapeau" style="width: 1rem; height: 1rem;"></div>
                                <div class="club-log"><img src="${player.logo}" alt="logo club" style="width: 1rem; height: 1rem;"></div>
                            </div>
                        </div>
